...
engine = sqlalchemy.create_engine('postgresql+psycopg2://postgres:07051998Sasha@localhost:5432/Race_Fight')
...
class History(Base):
    __tablename__ = 'history_log_sqlalchemy'

    match_id = Column(Integer, primary_key=True)
    winner = Column(String)
    rounds = Column(Integer)
    total_magic_damage_1 = Column(Integer)
    total_magic_damage_2 = Column(Integer)
    total_phisical_damage_1 = Column(Integer)
    total_phisical_damage_2 = Column(Integer)
    total_healing_1 = Column(Integer)
    total_healing_2 = Column(Integer)
    total_armor_1 = Column(Integer)
    total_armor_2 = Column(Integer)
...
while True:
    ...
    if p2.health < 1:
        ...
        history = History(winner=p1.name, rounds=round, total_magic_damage_1=total_magic_damage_1,
                          total_magic_damage_2=total_magic_damage_2, total_phisical_damage_1=total_phisical_damage_1,
                          total_phisical_damage_2=total_phisical_damage_2, total_healing_1=total_healing_1,
                          total_healing_2=total_healing_2, total_armor_1=total_armor_1, total_armor_2=total_armor_2)
        session.add(history)
        session.commit()
    ...
    if p1.health < 1:
        log_file = open('history.txt', 'a')
        log_file.write(f"Чемпион {p2.name} победил за {round} раундов!\n"
                       f"{p1.name} были использованы следующие карты: {using_cards_1}\n"
                       f"{p1.name} нанес маг. урона  - {total_magic_damage_1} ед.\n"
                       f"{p1.name} нанес физ. урона  - {total_phisical_damage_1} ед.\n"
                       f"{p1.name} получил лечения  - {total_healing_1} ед.\n"
        ...
        history = History(winner=p2.name, rounds=round, total_magic_damage_1=total_magic_damage_1,
                          total_magic_damage_2=total_magic_damage_2, total_phisical_damage_1=total_phisical_damage_1,
                          total_phisical_damage_2=total_phisical_damage_2, total_healing_1=total_healing_1,
                          total_healing_2=total_healing_2, total_armor_1=total_armor_1, total_armor_2=total_armor_2)
        session.add(history)
